...
class CreditCardGatewayTest extends \Omnipay\Tests\GatewayTestCase
{
    ...
    public function testAuthorizeSuccess()
    {
        ...
        $this->assertInstanceOf('\cartthrob\omnipay\paytrace\Message\CreditCard\AuthorizeResponse', $response);
    ...
    public function testRefundSuccess()
    {
        ...
        $this->assertInstanceOf('\cartthrob\omnipay\paytrace\Message\CreditCard\CaptureResponse', $response);
        $this->assertTrue($response->isSuccessful());
        $this->assertFalse($response->isRedirect());
        $this->assertNotEmpty($response->getTransactionReference());
